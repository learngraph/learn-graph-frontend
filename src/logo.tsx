const Logo = ({ size = 100 }) => {
  ...
  const nodes = [
    {
      x: centerX + lineLength + 1.2 * Math.cos(Math.PI / 2) - 23,
      y: centerY - lineLength * Math.sin(Math.PI / 2) - 10,
    },
    {
      x: centerX + lineLength * Math.cos((Math.PI * 6.9) / 6),
      y: centerY - lineLength * Math.sin((Math.PI * 5) / 6),
    },
    {
      x: centerX + lineLength + 12.91 * Math.cos((Math.PI * 11) / 6),
      y: centerY - lineLength * Math.sin((Math.PI * 7) / 6),
    },
    {
      x: centerX + lineLength * Math.cos((Math.PI * 13) / 4),
      y: centerY - lineLength * Math.sin((Math.PI * 11) / 6) + 15,
    },
  ];
