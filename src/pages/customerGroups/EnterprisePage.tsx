      ...
      <section id="begin" className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-5xl md:text-6xl font-serif mb-6">
            <span className="text-accent">{t("enterprise.hero.highlight")}</span>{" "}
            <span className="text-foreground">{t("enterprise.hero.title")}</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="customer-card p-6">
              ...
              <p className="text-foreground/70 text-sm leading-relaxed">{t(item.text)}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            >
              ...
              <div className="text-xs text-foreground/70 px-4">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="customer-card p-8">
              <h3 className="text-2xl font-semibold mb-4">{t(item.title)}</h3>
              <p className="text-foreground/70 leading-relaxed">{t(item.text)}</p>
            </div>
          ))}
        </div>
      </section>
